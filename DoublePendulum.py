...
Original file is located at
    https://colab.research.google.com/drive/1yW-bMJtTGkyQzjIf6SC8Y3tnEljs0s_W
"""
...
ln2, = ax.plot([], [], 'o-', markersize=8, alpha=0.05, color='cyan')   # Line for Earth
ln3, = ax.plot([], [], 'o-', markersize=8, alpha=0.05, color='cyan')
ax.set_ylim(-44, 44)
ax.set_xlim(-44, 44)
